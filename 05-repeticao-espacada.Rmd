...
1. Appends \[sound:xxx\] Tag onto Destination Field
...
Depois de selecionar uma cor que te agrada, copie o código hexadecimal gerado e cole-o no lugar da propriedade `background-color`. Eu escolhi o código `#f0eac2`, que é um amarelo bem claro. Se você estiver interessado em entender melhor como esses códigos de cores funcionam, talvez você precise se aprofundar um pouco mais em HTML e CSS do que compete o escopo desse site, e para isso eu comendo o [Khan Academy](https://pt.khanacademy.org/computing/computer-programming/html-css). Ou você pode procurar pela internet alguma explicação isolada sobre o sistema de cores hexadecimais.
...
![Isso só se aplica aos flashcards que sejam do `Tipo` "Básico com exemplos". Outros flashcards que não sejam desse tipo continuarão como antes.](img/tut55.png)
